...
export default function AddClient() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formDataState.imageFile) newErrors.image = "Client image is required.";
  ...
  return (
    <>
      ...
      {/* FORM */}
      <div className="bg-green-50 min-h-screen text-black py-10 mt-25 md:mt-35">
...
{formDataState.imagePreview ? (
  ...
  />
            ...
            >
              {loading ? "Uploading..." : <>Create <Send size={16} /></>}
            </button>
          </form>
        </div>
      </div>
